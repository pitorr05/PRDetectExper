...
if __name__ == '__main__':
    ...
    # Định nghĩa các file
    files = [
        ("detectrl_train_split", os.path.join(DATA_DIR, "detectrl_train_split.jsonl")),
        ("detectrl_val", os.path.join(DATA_DIR, "detectrl_val.jsonl")),
        ("detectrl_test", os.path.join(DATA_DIR, "detectrl_test.jsonl"))
    ]
